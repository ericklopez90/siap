...
urlpatterns = [
    ...
    path('catalogo/prestacionindi/', views.PrestacionIndiListView.as_view(), name='prestacionindi',),
    path('catalogo/prestacionindi/crear/', views.PrestacionIndiCreateview.as_view(), name='prestaindi-nuevo',),
    path('catalogo/prestacionindi/editar/<pk>/', views.PrestacionIndiUpdateView.as_view(), name='prestaindi-update',),
